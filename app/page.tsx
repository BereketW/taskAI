          ...
          <ScrollSection>
            ...
            <section className="w-full py-12 md:py-24 lg:py-32 xl:py-48 relative overflow-hidden">
              ...
              <div className="container px-4 md:px-6 relative z-10 rounded-lg">
                ...
                >
                  <div className="inline-block rounded-lg bg-primary/10 px-3 py-1 text-sm text-primary backdrop-blur-md hover-glow">
                    Introducing TaskAI
                  </div>
                  <div className="w-12 h-[1px] accent-line mx-auto my-2" />
                  <motion.h1
            ...
            <section className="w-full py-12 md:py-24 lg:py-32 relative">
              <div className="container px-4 md:px-6">
                <div className="grid gap-6 lg:grid-cols-2 lg:gap-12 items-center">
                  ...
                  <motion.div
                    className="mx-auto overflow-hidden rounded-xl border bg-background shadow-xl relative"
                    initial={{ opacity: 0, x: 50 }}
                    whileInView={{ opacity: 1, x: 0 }}
                    transition={{ duration: 0.5 }}
                    viewport={{ once: true }}
                  >
                    {/* Decorative elements */}
                    <motion.div
                      className="dashboard-decoration decoration-1"
                      style={{
                        top: "-20px",
                        right: "-20px",
                      }}
                    />
                    <motion.div
                      className="dashboard-decoration decoration-2"
                      style={{
                        bottom: "-30px",
                        left: "-30px",
                      }}
                      ...
                      <Card
                        className={`backdrop-blur-lg ${
                          plan.popular
                            ...
                            : "bg-white/10 dark:bg-gray-950/30 border-muted/40"
